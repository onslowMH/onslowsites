...
/*global jQuery */
/*!
 * Jquery driven jump menu. Initialize on a select form element
 * by Red Hammer, LLC 
 */
(function($) {
    $.fn.redhammerJumpMenu = function() {
        return this.each(function() {
            $this = $(this);
            //First we check for the WP class current-menu-item and display
            //that option as selected for a given page
            $this.find($("option")).each(function(i) {
                               
                var currentOption = $(this);
                if (currentOption.hasClass('current-menu-item')) {                    
            ...
            // In order to show the appropriate menu item as selected on mobile devices we detach, then re-attach
            // our menu AFTER we've assigned the selected attribute.
            $this.detach();
            $this.appendTo(".main_nav");
            
            //Now we set up our jump menu nav behavior
...
/*global jQuery */
/*!
 * Placeholder Text Controller 1.0
 * by Red Hammer, LLC
 * Usage: jQuery("[placeholder]").togglePlaceholder(); 
 */
(function($) {
    ...
    $.fn.togglePlaceholder = function() {
        ...
        if (!Modernizr.input.placeholder) {
            return this.each(function() {
                ...
                $('<span class="placeholder_fallback">' + placeholder_text + '</span>').insertBefore($this);
                $this.prev(".placeholder_fallback").on("click", function() {
                    $(this).hide();
                    //And give focus to our form field	
                    $this.trigger('focus');

                });
                $this.focus(function() {
                    $this.prev(".placeholder_fallback").hide();

                }).blur(function() {
                    if ($this.val() == '') {
                        $this.prev(".placeholder_fallback").show();
                    }
