<?php
if(class_exists('ONS_Staff_Custom_Post_Type') != true)
{ 
/*********************
* Our wrapper class for our post type
*/
include('RH_CPT_Methods.php');
class ONS_Staff_Custom_Post_Type extends RH_CPT_Methods  {
	...
	*/
	...
	public $codename		= 'ons_staff_cpt';
	public $singular_name 	= 'Staff';
	public $plural_name		= 'Staff';
	public $url_slug		= 'our-team';
	/**
