...
class ONS_Staff_Meta_Box extends RH_Custom_Field_Methods  {
	...
	*/
	...
	public $my_meta_box = array(
		'box_post_type'=>'ons_staff_cpt', 
		'box_id_attribute'=>'ons_staff_details_meta_box',
		'box_title'=>'Team Member Details',
	...
	*/	
	...
	public function first_meta_box_cb()
	{
		...
		?>
        	<!--rh_display_name-->
			<?php
			$fieldname = 'rh_display_name';
			$fieldlabel = 'Team Member Display Name:';
			$fieldplaceholder = '';
			$fieldvalue = $$fieldname;
			$fieldnotes = 'When populated, will override name in front-end.';
			...
			$fieldlabel = 'Team Member Display Title:';
			$fieldplaceholder = '';
			$fieldvalue = $$fieldname;
			$fieldnotes = 'When populated, will override title in front-end.';
			$basic_fields->get_text_input( $fieldname, $fieldlabel , $fieldvalue, $fieldnotes, $fieldplaceholder ); 
			?>
